...
$cards = [
  ...
  "item" => [
    1 =>  ["cost" => 3,  "points" => 1, "travel" => [SHIP, SHIP],   "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Sea Turtle")],
    2 =>  ["cost" => 3,  "points" => 1, "travel" => [CAR, CAR],     "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Ostrich")],
    3 =>  ["cost" => 4,  "points" => 1, "travel" => [CAR, CAR],     "action" => "main",       "exileItself" => false, "name" => clienttranslate("Pack Donkey")],
    4 =>  ["cost" => 4,  "points" => 1, "travel" => [CAR, CAR],     "action" => "main",       "exileItself" => false, "name" => clienttranslate("Horse")],
    5 =>  ["cost" => 3,  "points" => 3, "travel" => [SHIP, SHIP],   "action" => "free",       "exileItself" => false, "name" => clienttranslate("Steam Boat")],
    6 =>  ["cost" => 3,  "points" => 3, "travel" => [CAR, CAR],     "action" => "free",       "exileItself" => false, "name" => clienttranslate("Automobile")],
    7 =>  ["cost" => 1,  "points" => 1, "travel" => [CAR, CAR],     "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Sturdy Boots")],
    8 =>  ["cost" => 1,  "points" => 1, "travel" => [SHIP, SHIP],   "action" => "free",       "exileItself" => false, "name" => clienttranslate("Gold Pan")],
    9 =>  ["cost" => 1,  "points" => 1, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Trowel")],
    10 => ["cost" => 1,  "points" => 1, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Pickaxe")],
    11 => ["cost" => 2,  "points" => 1, "travel" => [PLANE],        "action" => "complex",    "exileItself" => true,  "name" => clienttranslate("Hot Air Balloon")],
    12 => ["cost" => 4,  "points" => 3, "travel" => [PLANE, PLANE], "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Aeroplane")],
    13 => ["cost" => 3,  "points" => 1, "travel" => [CAR, SHIP],    "action" => "complex",    "exileItself" => true,  "name" => clienttranslate("Journal")],
    14 => ["cost" => 2,  "points" => 2, "travel" => [SHIP],         "action" => "main",       "exileItself" => false, "name" => clienttranslate("Parrot")],
    15 => ["cost" => 1,  "points" => 1, "travel" => [SHIP],         "action" => "freeOrPass", "exileItself" => false, "name" => clienttranslate("Watch")],
    16 => ["cost" => 3,  "points" => 1, "travel" => [CAR, SHIP],    "action" => "main",       "exileItself" => false, "name" => clienttranslate("Army Knife")],
    17 => ["cost" => 4,  "points" => 1, "travel" => [SHIP],         "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Binoculars")],
    18 => ["cost" => 4,  "points" => 2, "travel" => [CAR],          "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Tent")],
    19 => ["cost" => 2,  "points" => 2, "travel" => [SHIP],         "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Fishing Rod")],
    20 => ["cost" => 4,  "points" => 1, "travel" => [SHIP],         "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Precision Compass")],
    21 => ["cost" => 2,  "points" => 2, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Bow and Arrows")],
    22 => ["cost" => 2,  "points" => 1, "travel" => [SHIP],         "action" => "free",       "exileItself" => false, "name" => clienttranslate("Carrier Pigeon")],
    23 => ["cost" => 2,  "points" => 1, "travel" => [CAR],          "action" => "complex",    "exileItself" => true,  "name" => clienttranslate("Whip")],
    24 => ["cost" => 1,  "points" => 1, "travel" => [SHIP],         "action" => "main",       "exileItself" => true,  "name" => clienttranslate("Rough Map")],
    25 => ["cost" => 2,  "points" => 1, "travel" => [PLANE],        "action" => "main",       "exileItself" => true,  "name" => clienttranslate("Airdrop")],
    26 => ["cost" => 2,  "points" => 1, "travel" => [SHIP],         "action" => "main",       "exileItself" => true,  "name" => clienttranslate("Flask")],
    27 => ["cost" => 4,  "points" => 1, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Machete")],
    28 => ["cost" => 2,  "points" => 2, "travel" => [SHIP],         "action" => "main",       "exileItself" => false, "name" => clienttranslate("Torch")],
    29 => ["cost" => 3,  "points" => 1, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Large Backpack")],
    30 => ["cost" => 2,  "points" => 1, "travel" => [SHIP],         "action" => "main",       "exileItself" => false, "name" => clienttranslate("Rope")],
    31 => ["cost" => 4,  "points" => 1, "travel" => [SHIP, SHIP],   "action" => "main",       "exileItself" => false, "name" => clienttranslate("Revolver")],
    32 => ["cost" => 1,  "points" => 1, "travel" => [SHIP],         "action" => "free",       "exileItself" => false, "name" => clienttranslate("Hat")],
    33 => ["cost" => 2,  "points" => 1, "travel" => [CAR],          "action" => "main",       "exileItself" => true,  "name" => clienttranslate("Bear Trap")],
    34 => ["cost" => 2,  "points" => 2, "travel" => [CAR],          "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Grappling Hook")],
    35 => ["cost" => 3,  "points" => 2, "travel" => [CAR],          "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Lantern")],
    36 => ["cost" => 3,  "points" => 1, "travel" => [CAR],          "action" => "complex",    "exileItself" => false, "name" => clienttranslate("Dog")],
    37 => ["cost" => 3,  "points" => 3, "travel" => [CAR],          "action" => "main",       "exileItself" => false, "name" => clienttranslate("Brush")],
    38 => ["cost" => 2,  "points" => 2, "travel" => [SHIP],         "action" => "main",       "exileItself" => false, "name" => clienttranslate("Axe")],
    39 => ["cost" => 3,  "points" => 2, "travel" => [SHIP, SHIP],   "action" => "freeOrPass", "exileItself" => false, "name" => clienttranslate("Chronometer")],
    40 => ["cost" => 3,  "points" => 1, "travel" => [SHIP],         "action" => "main",       "exileItself" => false, "name" => clienttranslate("Theodolite")]
  ],
  "basic" => [
    "fundcar"     => ["points" => 0,  "travel" => [CAR],  "action" => "free", "name" => clienttranslate("Funding")],
    "fundship"    => ["points" => 0,  "travel" => [SHIP], "action" => "free", "name" => clienttranslate("Funding")],
    "explorecar"  => ["points" => 0,  "travel" => [CAR],  "action" => "free", "name" => clienttranslate("Exploration")],
    "exploreship" => ["points" => 0,  "travel" => [SHIP], "action" => "free", "name" => clienttranslate("Exploration")],
    "fear"        => ["points" => -1, "travel" => [BOOT], "action" => "none", "name" => clienttranslate("Fear")]
  ]
];
